  ...
  const timeline = [
    {
      ...
      period: "2024 - 2028",
      description: " Focus on software development, database systems, networking and web technologies.",
    },
    {
      type: "education",
      icon: GraduationCap,
    ...
    },
    {
      ...
      icon: Briefcase,
      title: "Full Stack Developer",
      organization: "BenTech Hub",
      period: "2025 - Present",
      description: "Leading development of scalable full-stack solutions.",
    },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            Experience & <span className="bg-gradient-to-r from-purple-700 to-cyan-400 bg-clip-text text-transparent">Education</span>
          </h2>
